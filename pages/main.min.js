...
mainObj.news =
// создали поле news в объект mainObj
{
  item: document.querySelectorAll('._item'),
  //создали поле item в котором лежат три тега div с классом _item
  move()
  // создали метод с именем move
  {
    for (let i = 1; i < this.item.length; i++)
    // создали цикл, который проходится по нашим тегам div с классом _item
    {
